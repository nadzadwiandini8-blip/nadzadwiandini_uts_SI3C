...
mahasiswa.addEventListener("click", () => {
  setActive(mahasiswa);
  konten.querySelector(".welcome-card h1").textContent = "Selamat Datang, Nadza Dwi Andini -Kelas";
  
});

kelas.addEventListener("click", () => {
  setActive(kelas);
  konten.querySelector(".welcome-card h1").textContent = "Selamat Datang,  Nadza Dwi Andini- Kelas SI-3C";
